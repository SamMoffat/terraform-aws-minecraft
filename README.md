...
```
module "minecraft" {
  source = "git@github.com:darkestknight96/terraform-aws-minecraft.git?ref=master"
}
```
...
```
module "minecraft" {
  source = "git@github.com:darkestknight96/terraform-aws-minecraft.git?ref=v1.0"
}
```
